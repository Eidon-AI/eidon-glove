#ifndef TRACKER_DESCRIPTOR_H
#define TRACKER_DESCRIPTOR_H

#include <stdint.h>

// HID Report descriptor for Eidon Tracker (orientation sensor + vendor channels)
static const uint8_t tracker_report_map[] = {
...
// Report structure for tracker data (exactly 9 bytes)
typedef struct {
...
} __attribute__((packed)) tracker_hid_report_t;

#endif // TRACKER_DESCRIPTOR_H 